...
class Sheet1Generator:
    def __init__(self):
        ...
        # Sheet1 的設定
        self.blue_cols = 5      # 前5欄藍色
        self.orange_cols = 7    # 後7欄橘色
    ...
    def create_sheet(self, workbook, csv_file, sheet_name):
        ...
        # 凍結標題列和第一欄
        worksheet.freeze_panes = 'C3'  # 凍結 B2 以上和 B 欄以左
        
        print(f"✅ Sheet1 已創建完成 (前{self.blue_cols}欄藍色，後{self.orange_cols}欄橘色，凍結標題列+第一欄)")
